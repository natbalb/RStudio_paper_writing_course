...
format:
  ...
  pdf:
    pdf-engine: xelatex
    number-sections: false       #include numbers in each section
    margin-left: 0.8in
    margin-right: 0.8in
    margin-top: 0.8in
    margin-bottom: 0.8in
    toc: true                   # include a table of contents
    keep-tex: true              # save .tex file - just for pdf generation
    include-in-header:
      text: |
        \usepackage{lineno}
    include-before-body:
...
csl: ../styles/science.csl # change according to journal
---
...
[This]{.underline} is an R **Markdown** *document.* ^Markdown^ is a simple~simple~ formatting syntax for authoring HTML, PDF, and MS Word documents. For more details on using R Markdown see <http://rmarkdown.rstudio.com>.
...
Test of git show. [@Balbinott2022]
...
You can insert tables from source data, such as .csv or Excel <!--# this is a commment -->files and render them in html with the tinytable package.
